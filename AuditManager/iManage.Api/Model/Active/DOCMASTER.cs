namespace iManage.Api
{
    ...
    public partial class DOCMASTER
    {
        ...
        public virtual CUSTOM10 CUSTOM10 { get; set; }

        public virtual CUSTOM11 CUSTOM11 { get; set; }

        public virtual CUSTOM12 CUSTOM12 { get; set; }

        public virtual CUSTOM2 CUSTOM2 { get; set; }

        public virtual CUSTOM29 CUSTOM29 { get; set; }

        public virtual CUSTOM3 CUSTOM3 { get; set; }

        public virtual CUSTOM30 CUSTOM30 { get; set; }

        public virtual CUSTOM31 CUSTOM31 { get; set; }

        public virtual CUSTOM4 CUSTOM4 { get; set; }

        public virtual CUSTOM5 CUSTOM5 { get; set; }

        public virtual CUSTOM6 CUSTOM6 { get; set; }

        public virtual CUSTOM7 CUSTOM7 { get; set; }

        public virtual CUSTOM8 CUSTOM8 { get; set; }

        public virtual CUSTOM9 CUSTOM9 { get; set; }

        public virtual DOCCLASS DOCCLASS { get; set; }

        public virtual DOCSUBCLASS DOCSUBCLASS { get; set; }
